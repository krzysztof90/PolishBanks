...
namespace BankService.Bank_VeloBank
{
    public class VeloBankJsonResponse
    {
        ...
        {
            [DataMember]
            public List<VeloJsonResponseError> errors { get; set; }
        ...
        {
            [DataMember]
            public bool is_password_plain { get; set; }
            [DataMember]
            public string password_combinations { get; set; }
        }
        ...
        {
            [DataMember]
            public string hash_log { get; set; }
        }
        ...
        public class VeloJsonResponseConfirmResponseSessionCreate
        {
            ...
            [DataMember]
            public int session_inactivity_interval { get; set; }
            [DataMember]
            public int session_expiration_warning { get; set; }
            [DataMember]
            public string default_context_hash { get; set; }
        }

        [DataContract]
        public class VeloJsonResponseLoginPassword : VeloJsonResponseConfirmable
        {
            [DataMember]
            public VeloJsonResponseLoginPasswordConfirmationData confirmation_data { get; set; }
            [DataMember]
            public string access_token { get; set; }
            [DataMember]
            public VeloJsonResponseLoginPasswordConfirmationParams confirmation_params { get; set; }
            [DataMember]
            public string device_name { get; set; }
            [DataMember]
        ...
        {
            [DataMember]
            public bool is_confirmation_geolocalization { get; set; }
            [DataMember]
            public bool is_confirmation_device { get; set; }
            [DataMember]
            public bool is_show_add_device_popup { get; set; }
            [DataMember]
            public bool is_strong_auth_required { get; set; }
        }
        ...
        public class VeloJsonResponseConfirm : VeloJsonResponseBase
        {
            ...
            [DataMember]
            public VeloJsonResponseConfirmResponse response { get; set; }
            [DataMember]
        ...
        {
            [DataMember]
            public VeloJsonResponseConfirmResponseSessionCreate session_create { get; set; }
            [DataMember]
            public VeloJsonResponseConfirmResponseTransfersDomestic transfers_domestic { get; set; }
        }
        ...
        public class VeloJsonResponseConfirmResponseTransfersDomestic
    {
            ...
            [DataMember]
            public string id_transactions { get; set; }
            [DataMember]
            public string id_define_cyclics { get; set; }
            [DataMember]
            public List<string> permitted_operations { get; set; }
            [DataMember]
            public string required_action { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount amount { get; set; }
        }
        ...
        {
            [DataMember]
            public VeloBankJsonResponseAccountsAccounts accounts { get; set; }
        }
        ...
        public class VeloBankJsonResponseFastTransferAuthorize: VeloJsonResponseBase
        {
            ...
            [DataMember]
            public List<VeloBankJsonResponseFastTransferAuthorizeAgreement> agreements { get; set; }
            [DataMember]
            ...
            [DataMember]
            public int remaining_time_to_accept { get; set; }
            [DataMember]
            public int total_time_to_accept { get; set; }
        }
        ...
        public class VeloBankJsonResponseFastTransferPBL: VeloJsonResponseBase
        {
            ...
            [DataMember]
            public VeloBankJsonResponseFastTransferPBLPayment payment { get; set; }
            [DataMember]
            public List<VeloBankJsonResponseFastTransferProduct> products { get; set; }
            [DataMember]
        ...
        public class VeloBankJsonResponseFastTransferPBLPayment
    {
            ...
            [DataMember]
            public VeloBankJsonResponseAccountNumber nrb { get; set; }
        }
        ...
        public class VeloBankJsonResponseFastTransferAuthorizeAgreement
        {
            ...
            [DataMember]
            public List<VeloBankJsonResponseFastTransferAuthorizeAgreementProduct> products { get; set; }
            [DataMember]
            public List<string> owners { get; set; }
            [DataMember]
            public List<VeloBankJsonResponseFastTransferAuthorizeAgreementDetail> details { get; set; }
        }
        ...
        {
            [DataMember]
            public VeloBankJsonResponseAccountNumber account_number { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount available_funds { get; set; }
            [DataMember]
            public bool is_coowner { get; set; }
            [DataMember]
            public string id { get; set; }
            [DataMember]
        ...
        public class VeloBankJsonResponseFastTransferAuthorizeAgreementProduct: VeloBankJsonResponseFastTransferProduct
        {
            ...
            public string type { get; set; }
            [DataMember]
            public List<string> related_accounts { get; set; }
        }
        ...
        public class VeloBankJsonResponseFastTransferAuthorizeAgreementProductPayment
        {
            ...
            [DataMember]
            public VeloBankJsonResponseFastTransferAuthorizeAgreementProductPaymentRecipient recipient { get; set; }
            [DataMember]
            public VeloBankJsonResponseFastTransferAuthorizeAgreementProductPaymentSender sender { get; set; }
            [DataMember]
            public VeloBankJsonResponseFastTransferAuthorizeAgreementProductPaymentTransferData transfer_data { get; set; }
            [DataMember]
            public bool is_foreign { get; set; }
            [DataMember]
            public bool is_split_payment { get; set; }
            [DataMember]
            public bool is_commission_account_fixed { get; set; }
        }
        ...
        public class VeloBankJsonResponseFastTransferAuthorizeAgreementProductPaymentRecipient
        {
            ...
            [DataMember]
            public VeloBankJsonResponseBank bank{ get; set; }
            [DataMember]
            public VeloBankJsonResponseCountry country { get; set; }
            [DataMember]
        ...
        public class VeloBankJsonResponseCountry
        {
            ...
            [DataMember]
            public bool is_eea_country { get; set; }
            [DataMember]
            public bool is_iban { get; set; }
            [DataMember]
            public bool is_bad_iban_accepted { get; set; }
            [DataMember]
            public int iban_length { get; set; }
            [DataMember]
            public int iban_bank_no_from { get; set; }
            [DataMember]
            public int iban_bank_no_to { get; set; }
        }
        ...
        public class VeloBankJsonResponseFastTransferAuthorizeAgreementDetail
        {
            ...
            public string type { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount transfers_total_amount { get; set; }
            [DataMember]
            public List<VeloBankJsonResponseFastTransferAuthorizeAgreementProductPayment> payments { get; set; }
        }
        ...
        public class VeloBankJsonResponseAccountsAccounts
        {
            ...
            public List<string> permitted_operations { get; set; }
            [DataMember]
            public List<VeloBankJsonResponseAccountsAccountsSummary> summary { get; set; }
            [DataMember]
        ...
        {
            [DataMember]
            public List<VeloBankJsonResponseAccountsAccountsSummaryProduct> products { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount funds { get; set; }
            [DataMember]
        ...
        public class VeloBankJsonResponseAccountsAccountsSummaryProduct
        {
            ...
            public VeloBankJsonResponseAmount available_funds { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount balance { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount authorization_amount { get; set; }
            [DataMember]
            public string id { get; set; }
            [DataMember]
            public string product_name { get; set; }
        ...
        {
            [DataMember]
            public VeloBankJsonResponseBank recipient_bank { get; set; }
            [DataMember]
            public VeloBankJsonResponseTransferInfoPrognoseFee prognose_fee { get; set; }
            [DataMember]
            public bool sorbnet_status { get; set; }
            [DataMember]
            public VeloBankJsonResponseTransferStatus sorbnet { get; set; }
            [DataMember]
            public VeloBankJsonResponseTransferStatus express_elixir { get; set; }
            [DataMember]
        ...
        {
            [DataMember]
            public List<VeloBankJsonResponseTransferPrepaidInfoOperator> operators { get; set; }
            [DataMember]
            public VeloBankJsonResponseTransferPrepaidInfoAgreement agreement { get; set; }
        }
        ...
        public class VeloBankJsonResponseTransferPrepaidInfoOperator
        {
            ...
            public string display_name { get; set; }
            [DataMember]
            public List<VeloBankJsonResponseAmount> amounts { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount amount_min { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount amount_max { get; set; }
        }
        ...
        public class VeloBankJsonResponseTransferPrepaidInfoAgreement
        {
            ...
            public string description { get; set; }
            [DataMember]
            public List<VeloBankJsonResponseFile> file { get; set; }
            [DataMember]
        ...
        {
            [DataMember]
            public string bic_or_swift { get; set; }
            [DataMember]
            public string name { get; set; }
            [DataMember]
            public string address { get; set; }
        ...
        {
            [DataMember]
            public List<VeloBankJsonResponseHistoryItem> list { get; set; }
            [DataMember]
            public VeloBankJsonResponseHistoryPagination pagination { get; set; }
        }
        ...
        public class VeloBankJsonResponseHistoryItem
        {
            ...
            [DataMember]
            public VeloBankJsonResponseAmount amount_pln { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount balance { get; set; }
            [DataMember]
            ...
            [DataMember]
            public VeloBankJsonResponseHistoryItemRemitter remitter { get; set; }
            [DataMember]
            public VeloBankJsonResponseHistoryItemRecipient recipient { get; set; }
            [DataMember]
            ...
            [DataMember]
            public VeloBankJsonResponseHistoryItemMerchant merchant { get; set; }
            [DataMember]
            public VeloBankJsonResponseAmount amount { get; set; }
            [DataMember]
            ...
            public DateTime DateValue
            {
                ...
                set { date = value.ToString("yyyy-MM-dd", CultureInfo.CreateSpecificCulture("es-ES")); }
            }
